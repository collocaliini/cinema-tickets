...
class TestTicketService(TestCase):
    ...
    def test_purchase_tickets_0(self, seat_reservation_mock, ticket_payment_mock):
        TicketService().purchase_tickets(763, {"ADULT": 3, "CHILD": 5, "INFANT": 2})
    ...
    def test_purchase_tickets_1(self, seat_reservation_mock, ticket_payment_mock):
        TicketService().purchase_tickets(10001110101, {"CHILD": 5, "ADULT": 6})
    ...
    def test_purchase_tickets_2(self, seat_reservation_mock, ticket_payment_mock):
        TicketService().purchase_tickets(1, {"ADULT": 19})
    ...
    def test_purchase_tickets_3(self, seat_reservation_mock, ticket_payment_mock):
        TicketService().purchase_tickets(763, {"ADULT": 7, "CHILD": 8, "INFANT": 5})
    ...
    def test_purchase_tickets_bad_account(self):
        with self.assertRaises(TypeError):
            TicketService().purchase_tickets("hello", {"ADULT": 3})

        with self.assertRaises(ValueError):
            TicketService().purchase_tickets(-34, {"ADULT": 3})

    def test_purchase_tickets_bad_tickets(self):
        with self.assertRaises(ValueError):
            TicketService().purchase_tickets(17, {"ADULT": -1, "CHILD": 1})

    def test_purchase_tickets_no_tickets(self):
        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {})

        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"ADULT": 0, "CHILD": 0, "INFANT": 0})

    def test_purchase_tickets_too_many_tickets(self):
        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"ADULT": 10, "CHILD": 11, "INFANT": 12})

        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"ADULT": 33})

    def test_purchase_tickets_no_adults(self):
        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"CHILD": 5, "INFANT": 7})

        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"CHILD": 8})

    def test_purchase_tickets_too_many_infants(self):
        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"ADULT": 5, "CHILD": 6, "INFANT": 6})

        with self.assertRaises(InvalidPurchaseException):
            TicketService().purchase_tickets(17, {"ADULT": 5, "INFANT": 9})
